...
const I18N = {
  ko: {
    ...
    page_title_new: '티켓등록',
    page_title_edit: '티켓상세',
    page_title_editing: '티켓수정',
    ...
    badge_editing_in_progress: '편집 중',
    tooltip_editing_by_other: '다른 사용자가 편집 중입니다.',
  ...
  jp: {
    ...
    badge_editing_in_progress: '編集中',
    tooltip_editing_by_other: '他のユーザーが編集中です。',
    ...
    label_links: 'リンク',
    btn_select_mode: 'チケット移動・削除',
    btn_select_mode_active: '移動・削除をキャンセル',
  ...
  en: {
    ...
    page_title_editing: 'Edit Ticket',
    ...
    badge_editing_in_progress: 'Editing',
    tooltip_editing_by_other: 'Being edited by another user.',
    ...
    label_links: 'Links',
    btn_select_mode: 'Move/Delete Tickets',
    btn_select_mode_active: 'Cancel Move/Delete',
  ...
  vi: {
    ...
    page_title_new: 'Tạo vé',
    page_title_edit: 'Chi tiết',
    page_title_editing: 'Chỉnh sửa vé',
    ...
    badge_editing_in_progress: 'Đang chỉnh sửa',
    tooltip_editing_by_other: 'Người dùng khác đang chỉnh sửa.',
    ...
    btn_select_mode: 'Di chuyển/Xóa vé',
    btn_select_mode_active: 'Hủy di chuyển/xóa',
